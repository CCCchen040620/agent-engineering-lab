...
Write-Host "     Validates: async document ingestion task, failure diagnostics, retry event trace."
Write-Host "     Requires: PostgreSQL, FastAPI started with PostgreSQL DATABASE_URL, Ollama embedding model."
